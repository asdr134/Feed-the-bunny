...
function setup() {
  ...
  button3.position(550,120);
  button3.size(100,100);
  button3.mouseClicked(drop3);

  mute_btn = createImg('mute.png');
  mute_btn.position(canvasWidth - 100,20);
  mute_btn.size(50,50);
  mute_btn.mouseClicked(mute);
  
  rope1 = new Rope(7,{x:550,y:40});
  rope2 = new Rope(7,{x:250,y:70});
  rope3 = new Rope(7,{x:600,y:180});
  ground = new Ground(canvasWidth / 2,canvasHeight - 50,canvasWidth,20);


  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(420,canvasHeight - 200,100,100);
  bunny.scale = 0.4;
